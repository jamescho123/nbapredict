...
# Connection pooler with extended timeout and SSL options
...
def test_connections():
    ...
    print("\n2. Testing Supabase Connection Pooler (extended timeout: 60s)...")
    print("   Please wait... this may take up to 60 seconds")
    try:
        supabase_conn = psycopg2.connect(**SUPABASE_POOLER_CONFIG)
