...
"C:\Program Files\PostgreSQL\17\bin\psql.exe" -h localhost -d %DB_NAME% -U %DB_USER% -c "CREATE EXTENSION IF NOT EXISTS vector;"
...
"C:\Program Files\PostgreSQL\17\bin\psql.exe" -h localhost -d %DB_NAME% -U %DB_USER% -c "SELECT * FROM pg_extension WHERE extname = 'vector';"
