...
Keep the oldest team (earliest founding year) for each team name
"""
...
if __name__ == "__main__":
    print("\nThis script will:")
    print("1. Find all duplicate team names")
    print("2. For each duplicate, KEEP the oldest (earliest Founded year)")
    print("3. DELETE all newer duplicates")
    print("\nExample: Atlanta Hawks with From years 1949 and 1968")
    print("         → Keep 1949, delete 1968")
    print("\n" + "="*80)
